...
def ocr():
        ...
        try :
                ...
                #### Check Whether The Invoice Is Already Present In DB Or Not ####        
                db_connection.connect().execute(text("INSERT INTO PDF_AUDIT VALUES ( '"+file_name+"','COMPLETED','"+"')"))
            ...
            # print(e)
            db_connection.connect().execute(text("INSERT INTO PDF_AUDIT VALUES ( '"+file_name+"','ISSUE','"+str(e).replace("'","")+ "')"))
            db_connection.dispose()
